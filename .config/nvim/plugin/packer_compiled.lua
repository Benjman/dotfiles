...
_G.packer_plugins = {
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/auto-pairs"
  },
  ["galaxyline.nvim"] = {
    loaded = true,
  ...
  ["neoscroll.nvim"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/neoscroll.nvim"
  },
  nerdcommenter = {
    loaded = true,
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua"
  },
  ["nvim-colorizer.lua"] = {
    loaded = true,
