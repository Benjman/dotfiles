...
vim.g.nvim_tree_ignore = { '.git', '.gitignore', '.gitmodules', 'node_modules', '.cache' } --empty by default
...
vim.cmd [[ let g:nvim_tree_special_files = {} ]]-- List of filenames that gets highlighted with NvimTreeSpecialFile
