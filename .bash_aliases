...
alias lib="cd ~/.local/lib"
alias ll='ls -ahl'
alias make='make -j 32'
alias man="~/.local/lib/man"
alias more=less
...
alias nvim='[ ! -e /usr/local/bin/nvim ] && >&2 echo -e "\033[0;31m/usr/local/bin/nvim not found. Install with \"sh ~/.config/installs/nvim.sh\"" || /usr/local/bin/nvim'
...
alias u='pushd . > /dev/null && cd ~/src/uinta && $EDITOR . && popd > /dev/null'
alias ud='cd ~/src/uinta'
alias v='$EDITOR .'
alias vim='$EDITOR'
